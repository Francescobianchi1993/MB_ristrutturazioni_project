...
/**
 * Indirizzo pubblico mostrato sul sito e sui PDF. È la stessa casella che il
 * backend usa per spedire (GMAIL_USER) e su cui riceve le richieste
 * (LEAD_EMAIL): mittente e indirizzo pubblicato coincidono.
 */

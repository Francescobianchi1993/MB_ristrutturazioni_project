...
export const MACRO_SLOT: MacroSlot[] = [
  ...
  },
  {
    ...
    gruppo: 'macro',
    includesGli: [],
    tariffaACorpo: { min: 200, max: 1500 },
    ambiteApplicabili: 'tutto',
    disabilitatoSeCompleta: true,
    sottoVoci: [
      { id: 'p_idraulica', label: 'Riparazione idraulica', descBreve: 'Perdite, rubinetterie', pesoPct: 17 },
      { id: 'p_elettrica', label: 'Riparazione elettrica', descBreve: 'Sostituzione punti', pesoPct: 17 },
      { id: 'p_pittura', label: 'Ritocchi pittura', descBreve: 'Stuccatura e pittura locale', pesoPct: 17 },
      { id: 'p_serramenti', label: 'Riparazione serramenti', descBreve: 'Maniglie, cerniere', pesoPct: 17 },
      { id: 'p_pavimenti', label: 'Sostituzione piastrelle', descBreve: 'Riparazione pavimento', pesoPct: 16 },
      { id: 'p_altro', label: 'Altro', descBreve: 'Lavori puntuali', pesoPct: 16 },
    ],
  },
  {
    id: 'elettrico',
